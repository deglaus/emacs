...
TODO: add
*** Installation
For this to work, erlang needs to be installed on your device.
The file paths in the code needs to be adjusted to wherever erlang is installed. The name of the tools folder may vary due to a difference in versions of erlang; adjust that too.
*** Code
#+BEGIN_SRC emacs-lisp
