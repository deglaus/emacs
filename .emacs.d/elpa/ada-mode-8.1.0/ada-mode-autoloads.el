...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada-eglot" '("ada-eglot-" "eglot-ada")))
...
;;;***

;;;### (autoloads nil "ada_annex_p-process-lalr" "ada_annex_p-process-lalr.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from ada_annex_p-process-lalr.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada_annex_p-process-lalr" '("ada_annex_p-process-lalr-")))

;;;***

;;;### (autoloads nil "ada_annex_p-process-lr1" "ada_annex_p-process-lr1.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from ada_annex_p-process-lr1.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada_annex_p-process-lr1" '("ada_annex_p-process-lr1-")))

;;;***

;;;### (autoloads nil "ada_annex_p-process-tree_sitter" "ada_annex_p-process-tree_sitter.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from ada_annex_p-process-tree_sitter.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ada_annex_p-process-tree_sitter" '("ada_annex_p-process-tree_sitter-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "benchmark-xref" '("ada-mode-test" "bench")))
