...
#+LANGUAGE: en
#+OPTIONS: num:nil
Storstrogarn's GNUMACS: The Emacs distribution

[[./gnu.png]]
* Introduction
Storstrogarn's personal emacs configuration. ``init.el`` will read config.org; a lot of the configurations will be here, neatly organized.
* Why would I use this?
#+BEGIN_QUOTE
What's the difference between a villain and a super villain? Presentation!
#+END_QUOTE
It is a very basic config which means you can easily add, edit or remove things as you like. You can use this as a building block when making your OWN Emacs config! This config was based on [[https://github.com/snackon/Witchmacs][this repo by Snackon]]. 
* Quick install
Original:
#+BEGIN_SRC 
...
This one:
#+BEGIN_SRC 
git clone https://github.com/storstrogarn/emacs ~/.emacs.d
#+END_SRC
