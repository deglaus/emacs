...
(custom-theme-set-faces
 ...
 '(font-lock-negation-char-face ((((class color) (min-colors 257)) (:foreground "#B40318" :weight bold)) (((class color) (min-colors 89)) (:foreground "#CDC673" :weight bold))))
 ...
 '(match ((t (:background "#E6DB74" :foreground "#1B181D" :weight bold))))
 ...
 '(fringe ((((class color) (min-colors 257)) (:foreground "#F8F8F2" :background "#1B181D")) (((class color) (min-colors 89)) (:foreground "#F5F5F5" :background "#1B1E1C"))))
 ...
 '(menu ((((class color) (min-colors 257)) (:foreground "#F8F8F2" :background "#1B181D")) (((class color) (min-colors 89)) (:foreground "#F5F5F5" :background "#1B1E1C"))))
 '(minibuffer-prompt ((t (:foreground "#99CCFF"))))
 '(mode-line-buffer-id ((t (:foreground "#7864F9" :weight bold))))
 ...
 '(powerline-active1 ((((class color) (min-colors 257)) (:background "#3F0452")) (((class color) (min-colors 89)) (:background "#333333"))))
 '(powerline-active2 ((((class color) (min-colors 257)) (:background "#3F0452")) (((class color) (min-colors 89)) (:background "#1B1E1C"))))
 '(mode-line-inactive ((((class color) (min-colors 257)) (:inverse-video unspecified :underline unspecified :foreground "#75715E" :background "#1B181D" :box (:line-width 1 :color "#64645E" :style unspecified))) (((class color) (min-colors 89)) (:inverse-video unspecified :underline unspecified :foreground "#8B8878" :background "#1B1E1C" :box (:line-width 1 :color "#3D3D3D" :style unspecified)))))
 '(powerline-inactive1 ((((class color) (min-colors 257)) (:background "#172E6A")) (((class color) (min-colors 89)) (:background "#333333"))))
 '(powerline-inactive2 ((((class color) (min-colors 257)) (:background "#3F0452")) (((class color) (min-colors 89)) (:background "#1B1E1C"))))
 ...
 '(company-tooltip-selection ((t (:background "#99CCFF" :foreground "#3F0452"))))
 '(company-tooltip-mouse ((t (:background "#99CCFF" :foreground "#3F0452"))))
 ...
 '(linum ((((class color) (min-colors 257)) (:foreground "#8F908A" :background "#1B181D" :inherit default :underline nil)) (((class color) (min-colors 89)) (:foreground "#8F908A" :background "#1B1E1C" :inherit default :underline nil))))
 '(line-number ((((class color) (min-colors 257)) (:foreground "#8F908A" :background "#1B181D" :inherit default :underline nil)) (((class color) (min-colors 89)) (:foreground "#8F908A" :background "#1B1E1C" :inherit default :underline nil))))
 '(line-number-current-line ((((class color) (min-colors 257)) (:foreground "#F8F8F2" :background "#1B181D" :inherit default :underline nil)) (((class color) (min-colors 89)) (:foreground "#F5F5F5" :background "#1B1E1C" :inherit default :underline nil))))
 '(show-paren-match ((t (:background "#75715E" :foreground "#99CCFF" :inverse-video t :weight normal))))
 '(show-paren-mismatch ((t (:background "#1B181D" :foreground "#FF6666" :inverse-video t :weight normal))))
 '(tooltip ((((class color) (min-colors 257)) (:background "#FFFACE" :foreground "#262626" :inherit default))))
 '(undo-tree-visualizer-default-face ((((class color) (min-colors 257)) (:foreground "#75715E" :background "#1B181D")) (((class color) (min-colors 89)) (:foreground "#8B8878" :background "#1B1E1C"))))
 ...
 '(undo-tree-visualizer-active-branch-face ((((class color) (min-colors 257)) (:foreground "#F8F8F0" :background "#1B181D" :weight bold)) (((class color) (min-colors 89)) (:foreground "#FFFAFA" :background "#1B1E1C" :weight bold))))
 ...
 '(spaceline-highlight-face ((t (:background "#2A1241" :foreground "#DADADA"))))
 ...
 '(default ((t (:background "#1B181D" :foreground "#DADADA"))))
